...
type
  TFrmPaginas1 = class(TForm)
    ...
    procedure btn_tratamentoExceçãoClick(Sender: TObject);
  private
...
procedure TFrmPaginas1.btn_tratamentoExceçãoClick(Sender: TObject);
var
  i: Double;
begin
  i:= 10 / 2;
  ShowMessage('O resultado da operação é: ' + FloatToStr(i));
  advertencia('Operação realizada com sucesso');
end;
