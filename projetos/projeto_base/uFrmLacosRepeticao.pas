...
begin
  ...
  while i <= iLimite do
  begin
    ShowMessage('O índice atual é: ' + IntToStr(i));
    i := i + 1;
  end;
...
begin
  ...
  begin
    ShowMessage('O índice atual é: ' + IntToStr(j));
  end;
...
begin
  ...
  begin
    ...
    // Só altera os valores se já passou a primeira vez no laço
  ...
  ShowMessage('A sequência de Fibonnacci é: ' + #13 + sSequencia + '.');
