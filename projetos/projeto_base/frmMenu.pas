{ Nome: frmMenuPrincipal
  ...
  Data        Nome            Histórico
  05/11/2020  João da Silva   Criação.
  06/11/2020  José dos Santos Adicionado menu de laços de repetição.
}
unit frmMenu;
...
begin
  // Abre o formulário de Calculadora Básica
  // Isto é necessário, porque estamos aprendendo sobre comentários
...
begin
  ...
  if not(bAlgumMarcado) then
    // Não tem nenhum checkbox marcado
    dNumCalculado := 0
  else
  begin
