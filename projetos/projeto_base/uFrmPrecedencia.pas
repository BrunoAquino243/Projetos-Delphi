...
begin
    ...
    begin
        ...
        ShowMessage('O seu ingresso é grátis!');
        chkAbaixo10.Checked := false;
    end
    else
       if (Chk10a30.Checked = true) and (RdgEstacao.ItemIndex = C_VERAO) then // Outra opçao de verificar se ta marcado
    begin
          Dvaloringresso := (C_VLR_10A30 *  (C_AGIO_10A30 /100)) + C_VLR_10A30;
          sValorIngresso := ('O valor do seu ingresso é R$: ' + FloatToStr(Dvaloringresso));
          ShowMessage(sValorIngresso);
          Chk10a30.Checked := false;
     end
     else
     if (Chk10a30.Checked = true) and (RdgEstacao.ItemIndex = C_INVERNO) then // Outra opçao de verificar se ta marcado
    begin
     ...
     if (Chk10a30.Checked = true) and (RdgEstacao.ItemIndex = C_OUTONO) then // Outra opçao de verificar se ta marcado
    begin
       ...
       if (Chk10a30.Checked = true) and (RdgEstacao.ItemIndex = C_PRIMAVERA) then // Outra opçao de verificar se ta marcado
    begin
          Dvaloringresso := C_VLR_10A30;
          sValorIngresso := ('O valor do seu ingresso é R$: ' + FloatToStr(Dvaloringresso));
          ShowMessage(sValorIngresso);
     ...
     begin
        ...
        if (Chk31a60.Checked = true) and (RdgEstacao.ItemIndex = C_INVERNO) then // Outra opçao de verificar se ta marcado
    begin
     ...
     if (Chk31a60.Checked = true) and ((RdgEstacao.ItemIndex = C_OUTONO) or (RdgEstacao.ItemIndex = C_PRIMAVERA)) then // Outra opçao de verificar se ta marcado
    begin
     ...
     begin
      ...
      if (Chk61a100.Checked = true) and (RdgEstacao.ItemIndex = C_INVERNO) then // Outra opçao de verificar se ta marcado
    begin
      ...
      if (Chk61a100.Checked = true) and ((RdgEstacao.ItemIndex = C_OUTONO) or (RdgEstacao.ItemIndex = C_PRIMAVERA)) then // Outra opçao de verificar se ta marcado
    begin
...
begin
    ...
    sMensagem := 'O valor do ingresso é: R$ ' + FloatToStr(dValorIngresso);
